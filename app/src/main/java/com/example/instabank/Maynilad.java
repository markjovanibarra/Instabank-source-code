...
public class Maynilad extends AppCompatActivity {
                ...
                usersRef.orderByChild("phoneNumber").equalTo(currentUserPhoneNumber)
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                Toast.makeText(Maynilad.this, "Failed to fetch balance: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        }
                                ...
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.exists()) {
                                                        ...
                                                        snapshot.getRef().child("balance").setValue(newBalance)
                                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                    ...
                                                                    public void onSuccess(Void aVoid) {
                                                                        ...
                                                                        recordTransaction(name, accountNumber, -amount, "Maynilad", referenceId); // Pass -amount here
                                                                        ...
                                                                        Toast.makeText(Maynilad.this, "Payment of ₱" + amount + " successful", Toast.LENGTH_SHORT).show();


                                                                        // Show the receipt
                                                                        showReceipt(name, accountNumber, amount, "Maynilad", referenceId);
                                                                ...
                                                                .addOnFailureListener(new OnFailureListener() {
                                                                    ...
                                                                    public void onFailure(@NonNull Exception e) {
                                                                        Toast.makeText(Maynilad.this, "Failed to deduct balance: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                    }
                                                                });
                                                    } else {
                                            ...
                                            Toast.makeText(Maynilad.this, "User not found", Toast.LENGTH_SHORT).show();
                                        }
                                    }

                                    @Override
                                    public void onCancelled(DatabaseError databaseError) {
                                        Toast.makeText(Maynilad.this, "Failed to deduct balance: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
        ...
        usersRef.orderByChild("phoneNumber").equalTo(currentUser.getPhoneNumber())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            snapshot.getRef().child("rewards").setValue(newRewards).addOnCompleteListener(task -> {
                                if (task.isSuccessful()) {
                                    Toast.makeText(Maynilad.this, "Rewards updated successfully", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(Maynilad.this, "Failed to update rewards: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Maynilad.this, "Failed to update rewards: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private boolean isValidAmount(String amount) {
        // Check for valid amount format (no symbols or dots)
        String regex = "^\\d+(\\.\\d+)?$";
